...
class Pdf4ColGenerator:
    ...
    def generate(self, client_name, start_date, steps_dict):
        file_path = os.path.join(self.output_dir, f"{client_name.replace(' ', '_')}_4col.pdf")
        ...
        def draw_product_block(c, x, y, product, directions, max_width, font_size=10, line_height=12, dry_run=False):
            ...
            lines_above = 0  # Tracks whether we drew the product name
        ...
        for i in range(max_steps):
            ...
            cell_height = max(max(h1, h2, h3, h4), min_lines) * row_height + 5
